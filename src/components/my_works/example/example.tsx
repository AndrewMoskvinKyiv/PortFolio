...
export const Example = React.memo((props:any) => {
    ...
    return(
        <StyledExampleInner {...props}>
             ...
             <StyledLink href={props.link} target="_blank">{props.title}</StyledLink>
            <StyledSocialNetworkLink className={'my_link'}>

                <a href={"https://t.me/MoskvinAndrew"} target="_blank"><StyledSocialNetworkImg src={telegram} className={'my_picture'} /></a>
                <a href={"https://www.linkedin.com/in/andrew-moskvin-0090011a5/"} target="_blank"><StyledSocialNetworkImg src={linkedIn} className={'my_picture'} /></a>
