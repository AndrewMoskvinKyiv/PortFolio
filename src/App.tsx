...
import vue from "./images/vue.com.png"
        ...
        <div className="App">
            ...
            <section className='services__background'>
                <div className='services__items'>
                    ...
                    />
                    <Item icon={vue}
                          itemTitle={allData.servicesItem.itemTitle[4]}
                          itemText={allData.servicesItem.itemText[4]}
                    />
                    <Item icon={flutter}
                          itemTitle={allData.servicesItem.itemTitle[3]}
                          itemText={allData.servicesItem.itemText[3]}
                    />
